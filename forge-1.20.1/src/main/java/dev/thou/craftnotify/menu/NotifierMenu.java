...
public final class NotifierMenu extends AbstractContainerMenu {
    ...
    public static NotifierMenu fromNetwork(int containerId, Inventory inventory, FriendlyByteBuf buf) {
    ...
    public String availableChannels() { return availableChannels; }
